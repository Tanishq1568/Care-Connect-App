...
(function($) {
	...
	// Add logic for toggling between login and register views
	...
	if (loginButtonRegister && loginButtonAccess && loginAccessRegister) {
	...
	// Add form validation for login and register forms
